...
function StudentPage({ }: Props) {
  ...
  const columns: GridColDef[] = [
    ...
    { field: 'organizationId', headerName: 'Organization', flex: 1, editable: true, headerClassName: 'theme--header' },
    { field: 'enrolledCoursesIds', headerName: 'Enrolled Courses', flex: 1, editable: true, headerClassName: 'theme--header' },
    { field: 'currentClassId', headerName: 'Current Class', flex: 1, editable: true, headerClassName: 'theme--header' },
    ...
    { field: 'emergencyContacts', headerName: 'Emergency Contacts', flex: 1, editable: true, headerClassName: 'theme--header' },
    { field: 'enrollmentDate', headerName: 'Enrollment Date', flex: 1, editable: true, headerClassName: 'theme--header' },
    { field: 'graduationDate', headerName: 'Graduation Date', flex: 1, editable: true, headerClassName: 'theme--header' },
