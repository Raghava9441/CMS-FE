...
const appRoutes = {
    ...
    SETTINGS_PROFILE: '/CMS-FE/settings/profile',
    SETTINGS_NOTIFICATIONS: '/CMS-FE/settings/notifications',
    SETTINGS_THEME: '/CMS-FE/settings/theme',
    SETTINGS_DANGER_ZONE: '/CMS-FE/settings/danger-zone',
